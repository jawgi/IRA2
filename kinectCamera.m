...
%%
% Create a video input object for the kinect
kinect = Kinect();
%%
...
lightOrangeMask = (hsvFrame(:,:,1) >= lightOrangeHueMin) & (hsvFrame(:,:,1) <= lightOrangeHueMin) & ...
...
relativeFruitPosition = zeros(numFruit);
for i = 1:numFruit
    ...
    relativeFruitPosition(i) = kinect.getPixelCoordinates(295,236);
end
    

%%
relativeFruitPosition= kinect.getPixelCoordinates(247,141,1208);